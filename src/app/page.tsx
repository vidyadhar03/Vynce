    ...
    <div className="min-h-screen bg-[#FAFAFA] text-[#2E2E2E]">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-sm z-50 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <span className="text-xl font-semibold">Vynce</span>
          <button className="px-4 py-2 text-sm bg-[#4C7EFF] text-white rounded-full hover:bg-blue-600 transition-colors">
            Get Started
          </button>
        </div>
      </nav>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <button className="px-8 py-4 bg-[#4C7EFF] text-white rounded-full text-lg hover:bg-blue-600 transition-transform hover:scale-105">
                Get my free insight
              </button>
            </div>
      ...
      <footer className="py-12 px-4 border-t border-gray-100">
        <div className="max-w-6xl mx-auto text-center text-gray-600">
          <p>© 2025 Vynce. All rights reserved.</p>
          <div className="mt-4 space-x-6">
            <Link href="#" className="hover:text-[#4C7EFF]">Privacy</Link>
            <Link href="#" className="hover:text-[#4C7EFF]">Terms</Link>
            <Link href="#" className="hover:text-[#4C7EFF]">Contact</Link>
          </div>
        </div>
      </footer>
    </div>
